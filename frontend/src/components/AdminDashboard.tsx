    ...
    return (
        <div className="space-y-8">
            <div className="space-y-1">
                ...
                <p className="text-muted-foreground">Voici l'état actuel de votre espace admin.</p>
            </div>
            ...
            <div className="p-12 glass-panel rounded-3xl border-border/50 border-dashed text-center space-y-4">
                ...
                <div className="space-y-2">
                    <h3 className="text-xl font-bold uppercase italic tracking-tighter">Plus d'analyses arrivent</h3>
